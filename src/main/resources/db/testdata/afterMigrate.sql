...
insert into restaurant (id, name, delivery_tax, cuisine_id, register_date, update_date, address_city_id, address_postal_code,
                        address_street, address_number, address_neighbour, active, open)
